...
export const howToFishGame = {
  ...
  description:
    "Source-checked guides for the How to Fish Steam game, covering Drip fish and Fishipedia, boss progression, multiplayer limits, console plans, crossplay and Steam Deck support.",
  officialSummary:
...
export const howToFishSources = {
  ...
  itemIdGuide: {
    ...
    type: "Player-authored Steam Community guide",
    note:
      "Player-extracted save item list used only to verify current item and creature display names. It does not prove a location, lure, rate or legitimate unlock route."
  },
  fishLureGuide: {
    label: "Steam Community fish and lure guide",
    url: "https://steamcommunity.com/sharedfiles/filedetails/?id=3788992156",
    type: "Player-authored Steam Community guide",
    note:
      "Its current fish-to-lure chart pairs Triggerfish with Beginner Lure and Voxelfish with Professional Lure. This is player documentation, not an official probability or location table."
  },
  dripTriggerfishDiscussion: {
    label: "Steam Community Drip Triggerfish report",
    url: "https://steamcommunity.com/app/4001890/discussions/0/581680664978508443/",
    type: "Player discussion",
    note:
      "One player reports getting Drip Triggerfish after returning to Island 2 with Beginner Lure, following hundreds of unsuccessful attempts elsewhere. It supports a practical route, not a guaranteed result."
  },
  dripVoxelfishDiscussion: {
    label: "Steam Community Drip Voxelfish discussion",
    url: "https://steamcommunity.com/app/4001890/discussions/0/582806239606641006/",
    type: "Player discussion",
    note:
      "Multiple players report catching ordinary Voxel Fish on Island 4 with Professional Lure, while also reporting multi-hour dry streaks for the rare Drip variant. This supports a working route, not a guaranteed rate."
  },
  dripVoxelfishExistenceDiscussion: {
    label: "Steam Community Drip Voxelfish existence report",
    url: "https://steamcommunity.com/app/4001890/discussions/0/582806239606534846/",
    type: "Player discussion",
    note:
      "A player directly reports catching Drip Voxelfish, while others report long unsuccessful runs with Professional Lure. This supports existence but not a published drop rate."
  },
...
export const howToFishHub = {
  ...
  seoTitle: "How to Fish Game Guides: Bosses, Multiplayer & Platforms",
  description: howToFishGame.description,
  intro:
    "How to Fish is moving fast, while exact boss routes still depend on clearly labeled player evidence. This hub combines those routes with current official multiplayer, console-plan and Steam Deck facts.",
  quickAnswer:
    "Use the boat-key page for the starting-island Spider Crab, the Pufferfish page for the Island 3 route, the multiplayer page for eight-player and private-lobby facts, and the platform page for current console, Mac, crossplay and Steam Deck status.",
...
const rawHowToFishPages = [
  ...
  },
  {
    ...
    title: "How to Fish Fish Locations: Drip Voxelfish and Triggerfish",
    seoTitle: "How to Fish Drip Voxelfish & Triggerfish Locations",
    description:
      "Catch Drip Voxelfish and Triggerfish with the correct rod and lure, then use the source-checked Fishipedia checklist for other missing creatures.",
    intro:
      "Current search data shows players are specifically looking for Drip Voxelfish and Triggerfish. The two routes below use a current Steam Community lure chart plus direct player reports for the strongest reported islands. The remaining checklist keeps official facts separate from unverified spawn claims.",
    quickAnswer:
      "Use the Fishing Rod with Beginner Lure for Triggerfish; Forest (Island 2) is the reported best spawn location. Use the Fishing Rod with Professional Lure for Voxel Fish; Rocks (Island 4) is the reported best location. Drip variants use the same setup as the base creature, but their appearance is rare and no guaranteed rate is published.",
    updatedAtIso: "2026-08-31",
    eyebrow: "Drip fish routes plus Fishipedia checklist",
    status: "Two high-demand routes checked; full map still in progress",
    statusTone: "green",
    sections: [
      {
        heading: "Drip Voxelfish and Triggerfish setup",
        type: "table",
        columns: ["Target", "Rod and lure", "Best reported location", "Evidence boundary"],
        rows: [
          ["Triggerfish / Drip Triggerfish", "Fishing Rod + Beginner Lure", "Forest (Island 2)", "Community lure chart plus a direct Island 2 player report"],
          ["Voxel Fish / Drip Voxel Fish", "Fishing Rod + Professional Lure", "Rocks (Island 4)", "Community lure chart plus multiple Island 4 player reports"]
        ],
        note:
          "These are the strongest current community routes, not developer-published spawn rules. Keep the matching lure equipped, kill the Drip catch so Fishipedia can count it, and do not treat a long dry streak as proof that the route is wrong."
      },
      {
      ...
      {
        heading: "Current creature-name checklist from the save item list",
        type: "table",
      ...
      },
      {
        ...
        rows: [
          ["How do I catch Triggerfish?", "Fishing Rod plus Beginner Lure; Island 2 is the strongest current player-reported route", "Steam Community guide plus player report"],
          ["How do I catch Voxel Fish?", "Fishing Rod plus Professional Lure; Island 4 is the strongest current player-reported route", "Steam Community guide plus multiple player reports"],
          ["Do Drip variants need another lure?", "Current player routes repeat the matching base-fish lure; no separate Drip lure is documented", "Steam Community guide and reports"],
    ...
    faqs: [
      {
        ...
        a: "A complete developer-published fish-to-island map is not available. This page publishes the two routes supported by current search demand and source checks, then uses a five-island tracking method for entries that are not yet verified."
      },
      {
        q: "How do I catch Drip Voxelfish in How to Fish?",
        a: "Use the Fishing Rod with Professional Lure. Rocks (Island 4) is the best reported location. Current Steam reports show that even the ordinary Voxel Fish can take time and the Drip variant can require hours, so this is a route rather than a guaranteed spawn."
      },
      {
        q: "How do I catch Drip Triggerfish in How to Fish?",
        a: "Use the Fishing Rod with Beginner Lure. Forest (Island 2) is the best reported location. The Drip form uses the same equipment as the normal Triggerfish."
      },
      {
        q: "Does Drip Voxelfish exist in How to Fish?",
        a: "Yes, a current Steam Community report says a player caught it. Other players report multi-hour dry streaks with Professional Lure, so existence is supported but an exact rate or guaranteed method is not."
      },
      {
    ...
    relatedSlugs: ["how-to-get-boat-keys", "how-to-beat-pufferfish", "multiplayer-player-count"],
    sources: [
      howToFishSources.officialAchievements,
      ...
      howToFishSources.fishLureGuide,
      howToFishSources.dripTriggerfishDiscussion,
      howToFishSources.dripVoxelfishDiscussion,
      howToFishSources.dripVoxelfishExistenceDiscussion
    ]
  },
  {
...
export const publishedHowToFishSlugs = [
  "all-fish-locations",
  "how-to-get-boat-keys",
  "how-to-beat-pufferfish",
  "multiplayer-player-count",
  "console-crossplay"
];

export const publishedHowToFishSlugSet = new Set(publishedHowToFishSlugs);

export const publishedHowToFishPageList = publishedHowToFishSlugs
  .map((slug) => howToFishPages[slug])
  .filter(Boolean);

export const publishedHowToFishPages = Object.fromEntries(
  publishedHowToFishPageList.map((page) => [page.slug, page])
);
