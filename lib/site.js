...
export const pages = {
  ...
  abilities: {
    slug: "abilities",
    updatedAtIso: "2026-08-22",
    eyebrow: "Community meta comparison",
    title: "Grow a Chicken Fighter Best Abilities & Skill Tier List",
    seoTitle: "Grow a Chicken Fighter Best Abilities Tier List",
    shortTitle: "Best Abilities",
    description:
      "Compare the best Grow a Chicken Fighter abilities for Tower, Pit, survival and control, with three current tier lists cross-checked for consensus and disagreements.",
    intro:
      "The developer confirms that special abilities exist, but does not publish an official tier list. This guide compares three current community rankings and separates the abilities they consistently rate highly from the placements where they disagree.",
    status: "3 current rankings compared",
    statusTone: "green",
    answer:
      "Cycle of Ash and Voodoo are the clearest consensus picks: all three current sources place both in S tier. Rebirth is the strongest survival alternative, with two S placements and one A. Za Warudo is powerful control, but its B, A and S placements show that it depends heavily on the fight and ranking method.",
    sections: [
      {
        heading: "Best abilities at a glance",
        type: "table",
      ...
      {
        heading: "Which ability should you choose?",
        type: "cards",
        items: [
    ...
    faqs: [
      ...
      { q: "What is the best ability in Grow a Chicken Fighter?", a: "Cycle of Ash and Voodoo are the strongest current consensus picks because all three compared guide sites place both in S tier. The best choice still depends on whether you need sustain, reflected damage or control." },
