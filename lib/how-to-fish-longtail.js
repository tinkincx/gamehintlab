...
const longtailSources = {
  ...
  deckCompatibility: {
    ...
    type: "Official Steam data",
    note:
      "Steam currently categorizes the game as Playable, not Verified, and flags some interface text as potentially difficult to read."
  }
};
...
export const rawHowToFishLongtailPages = [
  ...
  },
  {
    ...
    description:
      "Get the first boat keys by using beer bait, beating the Spider Crab boss and returning its shell to the lighthouse keeper to unlock travel.",
    intro:
      "Boat access on the starting island is tied to the lighthouse keeper's culprit quest. The official achievement names that objective Who stole my beer; the bait, combat pattern and shell hand-in below come from a version 1.0.4 player route.",
    quickAnswer:
      "Bait the rod with beer to summon the Spider Crab, dodge its charge, move behind it during the stun and attack. Pick up the shell and give that exact trophy to the lighthouse keeper. He then gives you the first boat keys. The shell hand-in—not the boss kill by itself—is the progression trigger.",
    updatedAtIso: UPDATED_AT,
    eyebrow: "Starting-island progression",
    status: "Community route, official achievement endpoint",
    statusTone: "green",
    sections: [
      {
        ...
        rows: [
          ...
          ["Boss", "Spider Crab", "Player route"],
          ["Documented bait", "Beer", "Player route"],
          ["Required hand-in", "Spider Crab shell", "Player route"],
          ["Reward", "Boat keys", "Player route"]
        ]
      },
      {
        ...
        type: "steps",
        items: [
          "Finish the opening tasks and keep enough money for the gear shown in your current game.",
          "Equip beer as rod bait, following the player-authored route.",
          ...
          "After the kill, pick up the shell and carry it to the lighthouse keeper to receive the keys."
        ]
      },
      {
        ...
        items: [
          ...
          {
            title: "Use the stun",
            text: "The player guide describes a short stun after the missed charge. That is the safe damage window."
          },
          {
          ...
          {
            title: "Protect the trophy",
            text: "The shell is the quest item. Ordinary crab meat will not replace it for the documented hand-in."
          }
        ]
      },
      {
        ...
        items: [
          ...
          "Look for and pick up the shell after the fight.",
          "Carry the shell to the lighthouse keeper; do not substitute meat.",
    ...
    faqs: [
      {
        ...
        a: "The current player route awards them from the lighthouse keeper after you return the Spider Crab shell."
      },
      {
        q: "What bait catches the Spider Crab?",
        a: "The version 1.0.4 community route uses beer as the rod bait."
      },
      {
        q: "Why did killing the Spider Crab not unlock the boat?",
        a: "Pick up its shell and give that trophy to the lighthouse keeper. The hand-in is the documented progression step."
      },
      {
        q: "What do the first boat keys unlock?",
        a: "They unlock the boat used to leave the starting area and continue island progression in the current player route."
      }
    ],
    relatedSlugs: ["complete-walkthrough", "how-to-use-boat-radar", "how-to-get-leeches", "how-many-islands"],
  ...
  },
  {
    ...
    title: "How to Beat the Pufferfish in How to Fish: Carrot Bait and Tourist Quest",
    seoTitle: "How to Beat the Pufferfish in How to Fish",
    description:
      "Complete the Island 3 endangered-fish tourist request, get the carrot bait and survive both phases of the Pufferfish boss fight.",
    intro:
      "The carrot is not a normal shop lure. A player-authored version 1.0.4 route connects it to the Island 3 tourist and an endangered-fish hand-in. Patch 1.0.4 later nerfed the Pufferfish, so exact health and balance values remain version-sensitive.",
    quickAnswer:
      "On Island 3, catch an endangered fish with the pink Standard Lure and give it to the tourist. The player route lists Needlefish, Bowl Fish and Sea Horse as working examples. Take the carrot reward, use it as boss bait, then dodge the Pufferfish's rolls and stay out of the purple poison trail that begins in phase two.",
    updatedAtIso: UPDATED_AT,
    ...
    sections: [
      {
        ...
        type: "table",
        columns: ["Requirement", "Player-documented answer", "Why it matters"],
        rows: [
          ["Island", "Island 3", "Tourist and boss route"],
          ["Tourist catch", "An endangered fish", "Completes the tourist request"],
          ["Examples", "Needlefish, Bowl Fish or Sea Horse", "Listed by the community guide"],
          ["Fishing lure", "Pink Standard Lure", "Used for the endangered catch"],
          ["Boss bait", "Carrot", "Tourist reward used for Pufferfish"]
        ]
      },
      {
        ...
        type: "steps",
        items: [
          "Reach Island 3 and speak with the tourist so the request is active.",
          "Equip the pink Standard Lure named in the player-authored route.",
          "Catch a fish that the game marks as endangered; the guide lists Needlefish, Bowl Fish and Sea Horse as examples.",
          "Keep the correct fish intact and bring it to the tourist.",
      ...
      },
      {
        ...
        items: [
          {
            title: "Keep lateral space",
            text: "The player guide describes a rolling attack. Move across its line rather than staying directly in front."
          },
          {
            title: "Expect two phases",
            text: "At roughly half health, the guide reports that the boss begins leaving a purple poison cloud."
          },
          {
            title: "Do not cross the trail",
            text: "Let the boss move before taking a new firing angle; walking through the purple path adds avoidable damage."
          },
          {
            title: "Carry healing food",
            text: "Cooked fish gives you recovery without abandoning the fight, according to the community route."
          }
        ]
      },
      {
        ...
        type: "checklist",
        items: [
          "Do not confuse an endangered fish with a drip creature; they are separate labels in the player guide.",
          "Do not use the shark's Standard Boss Lure for this route; the tourist step uses the pink Standard Lure and rewards the carrot.",
          "Do not sell or cook the endangered fish before the tourist accepts it.",
          "Do not stand in the purple trail during the second phase.",
    ...
    faqs: [
      {
        ...
        a: "The community route says to give the Island 3 tourist an endangered fish; the tourist rewards you with the carrot."
      },
      {
        q: "Which fish work for the tourist?",
        a: "The version 1.0.4 player guide lists Needlefish, Bowl Fish and Sea Horse as working examples."
      },
      {
        q: "What lure should I use for the tourist quest?",
        a: "The community route uses the pink Standard Lure. It is not the Standard Boss Lure used for the shark."
      },
      {
        q: "What changes in the Pufferfish second phase?",
        a: "The player guide reports a purple poison trail beginning at half health. Avoid crossing it while you dodge and shoot."
      },
      {
    ...
    relatedSlugs: ["complete-walkthrough", "how-to-get-shark", "how-to-get-leeches", "how-to-beat-terrorizing-bird"],
    sources: [longtailSources.achievementRoute, longtailSources.patch104, longtailSources.officialAchievements]
  },
  {
  ...
  },
  {
    ...
    seoTitle: "How Many Players Is How to Fish? 8-Player Lobbies",
    description:
    ...
    intro:
      "The store's launch description calls How to Fish a 1-4 player game, but official Patch 1.0.4 later added support for lobbies of up to eight. The patch note is the newer and more specific source as of August 23, 2026.",
    quickAnswer:
      "How to Fish currently supports up to eight players in an online lobby. You can also play alone. Steam lists Single-player and Online Co-op; it does not list shared-screen or split-screen co-op, so this page does not claim couch multiplayer.",
    updatedAtIso: UPDATED_AT,
    ...
    sections: [
      ...
      },
      {
        ...
        type: "checklist",
        items: [
          "Make sure every player is on version 1.0.4 or later.",
          "Let Steam finish pending updates before creating or joining a lobby.",
          "Remember that the official minimum requirements include a broadband internet connection.",
          "If joining produces a black screen, verify files and test a freshly hosted lobby before changing save data.",
          "Do not treat the eight-player cap as evidence of console crossplay; no console version is currently announced."
        ]
      },
      {
        heading: "What Patch 1.0.4 changed for co-op",
        type: "table",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "No. The patch changes Steam lobby size; it does not announce a console version or cross-platform play."
      }
    ],
    relatedSlugs: ["console-crossplay", "black-screen-fix", "complete-walkthrough", "save-file-location"],
    sources: [longtailSources.patch104, longtailSources.officialStore, longtailSources.steamLaunchSupport]
  },
  {
  ...
  },
  {
    ...
    seoTitle: "Is How to Fish on PS5 or Xbox? Console & Crossplay",
    description:
      "Current How to Fish platform status: Windows PC, full controller support and Steam Deck Playable, with no announced console release or crossplay.",
    intro:
      "As of August 23, 2026, the official Steam listing and API show a Windows PC release. No official Xbox, PlayStation or Switch version—and therefore no console-to-PC crossplay support—has been announced. Controller support and Steam Deck compatibility do not mean a native console edition exists.",
    quickAnswer:
      "How to Fish is currently released on Windows through Steam. It has full controller support, including DualShock and DualSense, and Steam classifies it as Playable on Steam Deck rather than Verified. There is no official PS5, Xbox or Switch release or cross-platform-play announcement as of August 23, 2026.",
    updatedAtIso: UPDATED_AT,
    eyebrow: "Current official platform status",
    status: "Windows PC; no console release announced",
    statusTone: "amber",
    sections: [
      {
        ...
        rows: [
          ...
          ["PlayStation 5", "No official version announced", "DualSense support is controller support, not a PS5 release"],
          ["Xbox", "No official version announced", "No Xbox crossplay announcement"],
          ["Nintendo Switch", "No official version announced", "No Switch crossplay announcement"],
          ["Steam Deck", "Playable", "Not Steam Deck Verified"]
        ]
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            text: "Steam lists these controller families, so a PlayStation controller can be used with the PC game."
          },
          {
            title: "No native PS5 listing",
            text: "Recognizing a DualSense on PC does not create a PlayStation Store version."
          },
          {
            title: "No Xbox listing",
            text: "PC controller compatibility likewise does not establish an Xbox release."
          }
        ]
      },
      {
        ...
        rows: [
          ["Overall category", "Playable", "Not Verified"],
          ...
          ["Interface text", "Some text may be difficult to read", "Steam's current compatibility note"]
        ]
      },
      {
        ...
        type: "checklist",
        items: [
          "An official console version would need to be announced first.",
    ...
    faqs: [
      {
        ...
        a: "No official PS5 version has been announced as of August 23, 2026."
      },
      {
        q: "Is How to Fish on Xbox?",
        a: "No official Xbox version has been announced as of August 23, 2026."
      },
      {
      ...
      },
      {
        ...
        a: "No. Steam currently classifies it as Playable, with a note that some interface text may be difficult to read."
      }
    ],
    relatedSlugs: ["multiplayer-player-count", "black-screen-fix", "save-file-location", "complete-walkthrough"],
    sources: [longtailSources.officialStore, longtailSources.storeApi, longtailSources.deckCompatibility, longtailSources.patch104]
  }
];
