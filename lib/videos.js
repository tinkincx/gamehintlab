...
export const videoLibrary = {
  "egg-index-guide": {
    ...
    intro:
      "A 67-second visual walkthrough of the recorded Flock to Index route, the live fields to inspect and the facts that still need an in-game check.",
    durationLabel: "1:07",
  ...
  "fusion-screen-guide": {
    ...
    intro:
      "A 72-second visual walkthrough of the two-chicken Fuse route, the displayed cost, the preview and the limits of what one recorded interface can prove.",
    durationLabel: "1:12",
