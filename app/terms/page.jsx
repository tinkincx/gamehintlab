...
export default function TermsPage() {
  const schema = { "@context": "https://schema.org", "@type": "WebPage", name: "Game Hint Lab Terms of Use and Disclaimer", url: absoluteUrl("terms"), dateModified: "2026-08-19", isPartOf: { "@type": "WebSite", name: site.name, url: site.url } };
  return (
    <><JsonLd data={schema} /><main>
      <div className="article-hero-wrap"><div className="hero-grid-bg" /><div className="shell article-hero">
        ...
        <p className="eyebrow">Legal</p><h1>Terms of Use &amp; Disclaimer</h1><p className="article-intro">Last updated: August 19, 2026</p>
      </div></div>
      <div className="shell article-layout"><article className="article-body">
        <section className="article-section" id="acceptance"><div className="section-heading"><span>01</span><h2>Acceptance and permitted use</h2></div><p>By using Game Hint Lab, you agree to these terms. You may use the site for lawful, personal and informational purposes. You may link to our pages and quote brief portions with clear attribution, but you may not reproduce, republish, scrape at scale, sell or misrepresent our original guides without permission.</p></section>
        ...
        <section className="article-section" id="changes"><div className="section-heading"><span>06</span><h2>Changes, severability and contact</h2></div><p>We may update the site and these terms. The date above identifies the current version. If a provision is unenforceable, the remaining provisions continue to apply to the extent permitted by law. Questions, correction notices and rights-holder concerns may be sent through our <Link href="/contact/">contact page</Link>.</p></section>
